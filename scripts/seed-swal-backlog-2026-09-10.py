...
def main():
    ...
    tasks = [
        ...
        ("BIZ-01 ficha privada piloto + problema + disposicion pago", [], "local"),
        ("BIZ-02 catalogo y margen unico de cobro", [], "belal-decision"),
        ("FUND-01 presupuesto y paquete de ronda con evidencia", [], "local"),
        ("TOK-01 separar simulacion de financiacion", [], "local"),
        ("WAVE xavier-ola14 gate local + integracion PRs 1624-1633", [], "jules"),
        ("WAVE xavier-wave20 watch issues 2019-2024", [], "jules"),
        ("WAVE hosteler wave-close 320-324 + H4 SEC SAAS", [], "jules"),
